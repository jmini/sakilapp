...
import net.sakilapp.client.ui.desktop.outlines.pages.CategoriesTablePage.Table;
...
public class CategoriesSelectForm extends AbstractForm {
  ...
  public CategoriesSelectForm() throws ProcessingException {
    super();
  }
  ...
  public void startDisplay() throws ProcessingException {
    startInternal(new CategoriesSelectForm.DisplayHandler());
  }
  ...
  public class MainBox extends AbstractGroupBox {
    ...
    @Order(10.0)
    public class DisplayPageField extends AbstractPageField<CategoriesTablePage> {
      @Override
